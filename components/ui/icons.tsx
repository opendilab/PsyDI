...
function IconPsyDI({ className, ...props }: React.ComponentProps<'svg'>) {
  return (
    <svg
      fill="currentColor"
      viewBox="0 0 20 20"
...
function IconThumb({ className, ...props }: React.ComponentProps<'svg'>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
...
function getOppositeColor(currentColor: string) {
  // Convert current color to RGB values
  ...
  // Calculate inverse of each RGB value
  var inverseR = 255 - r;
  var inverseG = 255 - g;
  var inverseB = 255 - b;

  // Convert inverse RGB values to hexadecimal color code
  var oppositeColor = "#" + ((1 << 24) | (inverseR << 16) | (inverseG << 8) | inverseB).toString(16).slice(1);

  return oppositeColor;
}

function IconFullThumb({ className, ...props }: React.ComponentProps<'svg'>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 1792 1792"
